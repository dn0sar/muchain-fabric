...
func (stateTrie *StateTrie) GetStateSnapshotIterator(snapshot *gorocksdb.Snapshot) (stcomm.StateSnapshotIterator, error) {
...
func (stateTrie *StateTrie) GetRangeScanIterator(chaincodeID string, startKey string, endKey string) (stcomm.RangeScanIterator, error) {
